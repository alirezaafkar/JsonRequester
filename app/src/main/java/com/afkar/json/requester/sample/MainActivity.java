...
import com.afkar.json.requester.requesters.JsonArrayRequester;
import com.afkar.json.requester.requesters.JsonObjectRequester;
import com.afkar.json.requester.requesters.RequestBuilder;
import com.afkar.json.requester.sample.items.ErrorItem;
import com.afkar.json.requester.sample.items.GistItem;
...
import static com.afkar.json.requester.sample.items.GistItem.GistEntity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.user_action:
                mUserRequester.request(get, mUserAPi);
                break;
            case R.id.gists_action:
                mGistsRequester.request(get, mGistsAPi);
                break;
            case R.id.followers_action:
                mFollowersRequester.request(get, mFollowersAPi);
                break;
        }
